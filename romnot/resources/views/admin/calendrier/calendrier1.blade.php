                ...
                ">
                    ...
                    <div class="form-row mb-3">
                        <div class="form-group col-md-3">
                            <input type="time" class="form-control-lg col-md-12" placeholder="Début"
                                style="
                  border: 1px solid #3939b7 !important;
                  color: #3939b7 !important;
                " />
                        ...
                        <div class="form-group col-md-3">
                            <input type="time" class="form-control-lg col-md-12" placeholder="Fin"
                                style="
                  border: 1px solid #3939b7 !important;
                  color: #3939b7 !important;
                " />
                        ...
                        <div class="form-group col-md-6">
                            <input type="date" class="form-control-lg col-md-12" placeholder="Date"
                                style="
                  border: 1px solid #3939b7 !important;
                  color: #3939b7 !important;
                " />
                    ...
                    <div class="form-row mb-3"
                        style="display: flex; justify-content: center; border-radius: none;
            ">
                        ...
                        <div class="form-group col-3">
                            <button class="btn btn-md annuler" type="reset" id="annuler"
                                style="
