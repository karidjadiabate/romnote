...
<body>
    ...
    <div class="banner">
        ...
        <img class="img-fluid" src="{{ asset('assets/img/banniere.png') }}" alt="User 1" srcset="">
    </div>
    <!-- la suite -->
            ...
            @if (intval(auth()->user()->role_id) === 3)
                <div class="row text-start">
                    <div class="col-md-3 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <svg class="icon small-icon" xmlns="http://www.w3.org/2000/svg" width="43.75"
                                    height="35" viewBox="0 0 43.75 35">
                                    <path id="users-solid"
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <svg class="icon small-icon" xmlns="http://www.w3.org/2000/svg" width="30.448"
                                    height="34.798" viewBox="0 0 30.448 34.798">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <svg class="icon small-icon" xmlns="http://www.w3.org/2000/svg" width="31.318"
                                    height="34.798" viewBox="0 0 31.318 34.798">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <svg class="icon small-icon" xmlns="http://www.w3.org/2000/svg" width="35"
            ...
            <div class="container">
                <div class="row ">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="col-md-12 position-relative perfo p-2 mb-2">
                            <div class="d-flex justify-content-between align-items-center  p-3 mb-4 ">
                                <h4 class="mb-0 text-start">Performance de la classe</h4>
                                <div class="d-flex filterdash">
                                    <select class="form-select w-auto me-2 custom-select classic">
                                        <option selected>Filière...</option>
                                        <option value="1">Option 1</option>
                                        <option value="2">Option 2</option>
                                    </select>
                                    <select class="form-select w-auto custom-select classic">
                            ...
                            <table class="tables text-start  ">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label=""><span class="badge bg-warning bg-war">Non corrigé</span>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <script>
        $(document).ready(function() {
            $('.day.current-day').each(function() {
                var text = $(this).text();
                $(this).html('<span class="number">' + text + '</span>');
            });
        });
    </script>
</body>
