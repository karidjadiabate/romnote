...
<body>
            ...
            <table class="table" id="etablissementTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{asset('storage/logo/'.$etablissement->image)}}" width="50" height="50" class="img-circle elevation-2" alt=""></td>
                        <td class="no-print">
                            <button class="btn btn-outline-primary btn-sm"
                                data-bs-toggle="modal" data-bs-target="#editEtablissementModal{{$etablissement->id}}"
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{route('etablissement.update', $etablissement->id)}}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="nometablissement" placeholder="Nom Etablissement" value="{{$etablissement->nometablissement}}" required>
                                                <div class="invalid-feedback">
                                                    Le nom de l'établissement est requis.
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="nomresponsable" placeholder="Nom Responsable" value="{{$etablissement->nomresponsable}}" required>
                                                <div class="invalid-feedback">
                                                    Le nom du responsable est requis.
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="prenomresponsable" placeholder="Prénom Responsable" value="{{$etablissement->prenomresponsable}}" required>
                                                <div class="invalid-feedback">
                                                    Le prénom du responsable est requis.
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="tel" class="form-control" name="contact" placeholder="Contact" value="{{$etablissement->contact}}" required>
                                                <div class="invalid-feedback">
                                                    Le contact est requis.
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="adresse" placeholder="Adresse Etablissement" value="{{$etablissement->adresse}}" required>
                                                <div class="invalid-feedback">
    ...
    <div class="modal fade" id="etablissementModal" tabindex="-1" aria-labelledby="etablissementModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{route('etablissement.store')}}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="nometablissement" placeholder="Nom Etablissement" required>
                                <div class="invalid-feedback">
                                    Le nom de l'établissement est requis.
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="nomresponsable" placeholder="Nom Responsable" required>
                                <div class="invalid-feedback">
                                    Le nom du responsable est requis.
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="prenomresponsable" placeholder="Prénom Responsable" required>
                                <div class="invalid-feedback">
                                    Le prénom du responsable est requis.
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="adresse" placeholder="Adresse Etablissement" required>
                                <div class="invalid-feedback">
                                    L'adresse est requise.
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            searchTable('#etablissementTable', 'searchInput');
