...
<body>
    ...
    <div class="container">
        <div class="printableArea">
            <h1 class="mt-4 mb-4 text-center">Liste des niveaux</h1>
                ...
                <div>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#" onclick="exportTableToPDF('#niveauTable')">PDF</a>
                            </li>
                        </ul>
                    </div>
                    <button class="btn btn-ajout mr-2" data-bs-toggle="modal" data-bs-target="#addNiveau"><i
                            class="fa-solid fa-plus"></i> Ajouter un niveau</button>
                </div>
                <!-- <div class="btn-group">
            ...
            <table class="table" id="niveauTable">
                ...
                <tbody id="niveauTables">
                    ...
                    <tr>
                        ...
                        <td class="no-print">
                            <button class="btn btn-outline-primary btn-sm"
                                ...
                                data-nomniveau="{{$niveau->nomniveau}}">
                    ...
                    <div class="modal " id="editNiveau{{$niveau->id}}" tabindex="-1" aria-labelledby="editNiveauLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content " wi>
                                <h1 class="text-center">Modifier</h1>
                                <form action="{{route('niveau.update', $niveau->id)}}" method="POST" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="code" placeholder="Ex: L1, L2" value="{{$niveau->code}}" required>
                                            ...
                                            <!-- Fields for editing teacher details -->
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="nomniveau" placeholder="Ex: Licence 1, Licence 2" value="{{$niveau->nomniveau}}" required>
                    ...
                    <div class="modal " id="deleteniveau{{$niveau->id}}" tabindex="-1" aria-labelledby="deleteNiveauLabel" aria-hidden="true">
    ...
    <div class="modal " id="addNiveau" tabindex="-1" aria-labelledby="addNiveauLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content " wi>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            searchTable('#niveauTables', 'searchInput', 'noResults');
