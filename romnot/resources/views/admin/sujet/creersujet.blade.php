    ...
    <form action="{{route('sujetprofesseur.store')}}" class="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-step">
            <div class="note-container">
                <span>Note:</span>
                <input type="text" name="noteprincipale" class="note-value" placeholder="Entrez le nombre total de points *" />
            ...
            <div class="frm" style="display: none">
                <div class="sa">
                    ...
                    <div class="input-group">
                        <input type="text" name="sections[0][titre]" id="phone" placeholder="Sous titre 1" required />
                    </div>
                    <div class="input-group input-with-icon">
                        <input type="text" name="sections[0][soustitre]" id="preview" placeholder="Libellé du sous titre" required />
                                ...
                                <div class="input-group">
                                    <div class="questionnaire">
                                        <div class="input-group">
                                            <div class="display-1">
                                                <div class="textarea">
                                                    <textarea name="sections[0][questions][0][libquestion]" id="previews" required
                                        ...
                                        <div class="input-group">
                                            <ol class="circle-list">
                                                <li>
                                                    <input type="text" class="heckbox-reponce" id="checkbox1" name="sections[0][questions][0][reponses][0][libreponse]"
                                                    ...
                                                    <select name="sections[0][questions][0][reponses][0][result]" id="mySelect" class="Select">
                                                        <option value="" disabled selected hidden>
                                                            resultat
                                                        </option>
                                                        <option value="bonne_reponse" class="green" data-target="1">
                                                            Bonne réponse
                                                        </option>
                                                        <option value="mauvaise_reponse" class="yellow" data-target="2">
                                                            Mauvaise réponse
                                                        </option>
                                                        <option value="mauvaise_reponse-" class="red" data-target="3">
                                                            Mauvaise réponse(-)
                                                        </option>
                                                    </select>
                                                    <input type="number" id="point" class="point" name="sections[0][questions][0][reponses][0][points]" required
                                                        placeholder="not 1" />
        ...
        if (sectionsContainer) {
            ...
            newSections.innerHTML = `
                ...
                <div class="input-group input-with-icon">
                    ...
                    <img id="image-preview${sectionCounter}" alt="Aperçu de l'image" />
                </div>`;
    ...
    function attachResponseEvent(sectionElement) {
        ...
        if (addResponseButton) {
            addResponseButton.addEventListener("click", function (event) {
                ...
                const questionIndex = sectionElement.closest(".questionnaire-container").id.split('-')[1];
