...
<style>
    ...
    .modal-dialog {
        max-height: 90vh;
        /* Limite la hauteur maximale pour éviter le défilement */
        display: flex;
        align-items: center;
    }
...
<body>
    ...
    <div class="container">
        <div class="printableArea">
            <h2 class="text-start">Liste des sujets</h2>
    ...
    <div class="modal fade" id="impri" tabindex="-1" style="background-color: #a29de6"
        aria-labelledby="scannModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="background-color: #4A41C5">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="scannModalLabel">Connecter un scanner</h2>
                    <button type="button" class="custom-close-btn" data-bs-dismiss="modal" aria-label="Close">
                        <i class="fas fa-times"></i> <!-- Icône de fermeture Font Awesome -->
                    </button>
                </div>
