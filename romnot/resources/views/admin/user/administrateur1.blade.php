                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <button type="button" class="custom-close-btn" data-bs-dismiss="modal"
                                            ...
                                            <form action="{{ route('user.update', $administrateur->id) }}"
                                                ...
                                                <div class="modal-body">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control"
                                                                id="editPrenom{{ $administrateur->id }}"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="email" class="form-control"
                                                                id="editEmail{{ $administrateur->id }}"
                                                                name="email" placeholder="Email"
                                                                value="{{ $administrateur->email }}" required>
                                                            <div class="invalid-feedback">
                                                                Email est requis.
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="tel" class="form-control"
                                                                id="editContact{{ $administrateur->id }}"
