...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,600&display=swap"
        rel="stylesheet">
            ...
            <form action="{{route('demandeinscription.store')}}" id="registrationForm" method="POST">
                ...
                <div class="form-group d-flex align-items-center justify-content-between">
                    <div class="form-check mr-3">
                        ...
                        <label id="et" class="form-check-label" for="rememberMe">J'ai lu et j'accepte les <a href="#">
                                Termes et Conditions</a> <br>ainsi que la <a href="#">Politique de
