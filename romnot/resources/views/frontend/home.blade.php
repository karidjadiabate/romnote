...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/essai.css') }}">
        ...
        <div class="content">
            ...
            <form class="d-flex mb-3">
                ...
                <a href="#demo" class="btn btn-outline-success btn-no-rounded">
                    <i class="fa-solid fa-play" style="color: #f8f9fc; margin-right: 3px;"></i> Regardez un démo
                </a>
            </form>
        </div>

        <div class="image-slider">
            <img src="{{ asset('frontend/img/Fichier 15.png') }}" alt="Foreground Image"
                class="foreground-image active">
            <img src="{{ asset('frontend/img/Fichier 16.png') }}" alt="Foreground Image" class="foreground-image">
            <img src="{{ asset('frontend/img/Fichier 18.png') }}" alt="Foreground Image" class="foreground-image">
        </div>
        <div class="bouton">
            ...
            <div class="row mb-3 feature-row">
                ...
                <div class="row justify-content-center text-align-center">
                    <a href="#" class="btn btn-primary mt-3" data-bs-toggle="modal"
                        data-bs-target="#myModal">Demander un essai gratuit</a>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <span style="color: #00cc99;">AKP</span> ROM-Note
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Essayez ROM-Note gratuitement.</p>
                    <form>
                        <div class="mb-3">
                            <input type="text" class="form-control" placeholder="Entrez votre Nom & Prénoms">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 custom-checkbox">
                            ...
                            <label for="terms">
                                J'ai lu et j'accepte les <a href="#">Termes et conditions</a> ainsi que la <a
                                    href="#">Politique de confidentialité</a>.
                            </label>
                        </div>
                        <button type="submit" class="btn btn-primary w-100">Demandez un essai gratuit</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container text-center">
            ...
            <div class="container mt-4">
                <div class="row justify-content-center">
                    ...
                    <div class="col-6 col-md-2 mb-4 d-flex justify-content-center">
                        <img src="{{ asset('frontend/img/UNIVERSITE-NORD-SUD-.png') }}" alt="Logo 8"
                            class="img-fluid">
                    </div>
                    <div class="col-6 col-md-2 mb-4 d-flex justify-content-center">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 logo-info mb-3 mb-md-0 mx-auto">
                    ...
                    <div class="row ">
                        <div class="col-6 "><img src="{{ asset('frontend/img/logo boodruch 2.png') }}"
                                alt="KPANY" class="img-fluid"></div>
                        <div class="col-6 mb-3"><img src="{{ asset('frontend/img/familia pro.png') }}"
                                alt="KPANY" class="img-fluid"></div>
                        <div class="col-6 mb-3"><img src="{{ asset('frontend/img/Log1.png') }}" alt="FEMILIA"
                                class="img-fluid"></div>
                        <div class="col-6 mb-3"><img src="{{ asset('frontend/img/Log4.png') }}" alt="VEMISTERS"
                                class="img-fluid"></div>
                        <div class="col-6 mb-3"><img src="{{ asset('frontend/img/bodruch.png') }}" alt="BODRUCH"
                                class="img-fluid"></div>
                    </div>
                </div>
